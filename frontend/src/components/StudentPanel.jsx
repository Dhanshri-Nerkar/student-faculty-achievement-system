    ...
    <div style={{ padding: "20px", maxWidth: "1400px", margin: "0 auto" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap" }}>
          <div>
            <h1 style={{ fontSize: "28px", marginBottom: "10px" }}>👨‍🎓 Student Dashboard</h1>
            <p style={{ opacity: 0.9 }}>Welcome back, {user?.name || "Student"}!</p>
          </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "30px" }}>
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit}>
            <h3 style={{ color: "#667eea", marginBottom: "15px", fontSize: "18px" }}>Basic Details</h3>
            ...
            <h3 style={{ color: "#667eea", marginBottom: "15px", fontSize: "18px" }}>Achievement Details</h3>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              {data.map((item) => (
                ...
                >
                  ...
                  {item.achievementType && <p><strong>Achievement:</strong> {item.achievementType}</p>}
